                            ...
                            <table class="table table-hover" border="1" class="cell-border">
                                ...
                                <tbody>
                                    ...
                                    <tr align="center">
                                        ...
                                        ?></td>
                                        <td>
                                            <?php echo '<a href="'.base_url().'download_patient_surgery_file/'. ($value['hospital_surgery_file']).'/'.$value['id'].'" target="_blank"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" style="color:#4ab733;">
