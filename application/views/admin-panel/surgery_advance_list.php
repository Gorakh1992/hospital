        ...
        <div class="row">
            <div class="agency-list">
                <div class="fliters">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="surgery_patient_name" name="surgery_patient_name" value="" placeholder="Enter Adhar Number">
                        </div>
                        <div class="col-md-3">
                            <select id="surgery_type_id" name="surgery_type_id">
                                <option selected="" value="">Select Surgery Name</option>
                        ...
                        <div class="col-md-4">
                            <button type="button" id="search_surgery_patient" style="width: 100%;" class="btn btn-primary">Search</button>
                        </div>
                    </div>
